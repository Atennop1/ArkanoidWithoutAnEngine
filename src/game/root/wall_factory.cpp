...
genesis::SharedPointer<Wall> WallFactory::Create(genesis::WindowReferences window_references, const char *texture_file_path, genesis::PhysicalProperties physical_properties)
{
