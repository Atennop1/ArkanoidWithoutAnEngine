...
public:
	...
	/// Allocate memory. This will use Box2D::Alloc if the size is larger than maxBlockSize.
	void* Allocate(int32 size);

	/// Free memory. This will use Box2D::Free if the size is larger than maxBlockSize.
