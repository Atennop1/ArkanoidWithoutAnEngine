#ifndef ARKANOIDWITHOUTANENGINE_INCLUDE_GAME_LOOP_TIME_AVERAGE_GAME_TIME_HPP_
#define ARKANOIDWITHOUTANENGINE_INCLUDE_GAME_LOOP_TIME_AVERAGE_GAME_TIME_HPP_
