#ifndef ARKANOIDWITHOUTANENGINE_INCLUDE_GAME_LEVEL_CONSTANTS_LEVEL_LAYOUTS_HPP_
#define ARKANOIDWITHOUTANENGINE_INCLUDE_GAME_LEVEL_CONSTANTS_LEVEL_LAYOUTS_HPP_
