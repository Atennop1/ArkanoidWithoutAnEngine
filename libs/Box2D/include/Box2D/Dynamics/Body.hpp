...
public:
	...
	/// This is a convenience function. Use Box2D::FixtureDef if you need to set parameters
	...
	/// Note: contacts are updated on the next call to Box2D::World::Step.
	...
	/// An inactive body is still owned by a Box2D::World object and remains
	/// in the body list.
	...
	/// miss some collisions if you don't use Box2D::ContactListener.
