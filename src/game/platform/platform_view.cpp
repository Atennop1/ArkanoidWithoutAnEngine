...
namespace arkanoid
{
PlatformView::PlatformView(const genesis::WindowReferences &window_references) : window_references_(window_references)
{
...
{
    SDL_FRect rect = genesis::Shortcuts::PositionAndTextureToRect(window_references_.Window(), position, platform_texture_, 6, 6);
