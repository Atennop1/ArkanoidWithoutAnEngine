...
if(CMAKE_SIZEOF_VOID_P EQUAL 4)
    set(exec_prefix "${CMAKE_CURRENT_LIST_DIR}/modules/SDL2_image/i686-w64-mingw32")
elseif(CMAKE_SIZEOF_VOID_P EQUAL 8)
    set(exec_prefix "${CMAKE_CURRENT_LIST_DIR}/modules/SDL2_image/x86_64-w64-mingw32")
endif()
...
set(SDL2_IMAGE_LIBRARIES "${libdir}/libSDL2_image.a")
set(_sdl2image_bindir        "${bindir}")
set(_sdl2image_libdir     "${libdir}")
set(SDL2_IMAGE_INCLUDE_DIR   "${includedir}/SDL2")
